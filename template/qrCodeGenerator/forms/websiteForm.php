<div class="row">
    <div class="col-12">
        <div class="mb-3">
            ...
            <input type="text" name="qrcodeGeneratorWebsiteInput" id="qrcodeGeneratorWebsiteInput" class="form-control" placeholder="<?= $this->e($this->translate('qrcode-generator-preset-website-input-placeholder')) ?>">
            <small>
