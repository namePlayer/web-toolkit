...
<div class="container mt-3">
    ...
    <div class="row mt-3">
        ...
        <div class="col-3">
            ...
            <button class="btn btn-primary w-100 mb-3"><?= $this->translate('support-create-ticket-button') ?></button>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr class="align-middle">
                            <th scope="row">3</th>
                            <td>Höheres Level nicht freigeschalten</td>
                            <td>
                        ...
                        <tr class="align-middle">
                            <th scope="row">1</th>
                            <td>Lizenz nicht verfügbar</td>
                            <td>
                                <span class="badge rounded-pill text-bg-success">Offen</span>
                            </td>
                            <td>30.03.2022</td>
                            <td>
                                <button type="button" class="btn btn-outline-secondary rounded-pill btn-sm">
